...
// Importa las rutas relacionadas con vehículos
import routerV from './routes/VEHICULORoute.js'; // importar

// Importa la función para establecer la conexión a la base de datos
import { getConnection } from './config/connection.js'

// Importa las rutas relacionadas con usuarios
import routerU from './routes/USUARIORoute.js'
