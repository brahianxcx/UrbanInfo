...
export default function ListarUsuarios() {
    ...
    const handleSubmit = (e) => { // Maneja el registro de un nuevo usuario
        ...
        axios.post('http://localhost:3000/usuarios/TablaUsuarios', Usuario)
            .then(response => {
    ...
    const handleEditar = (e) => { // Maneja la edición de un usuario existente
        ...
        axios.put(`http://localhost:3000/usuarios/TablaUsuarios/${Usuario.UserID}`, Usuario)
            .then(response => {
    ...
    const handleDelete = async (UserID) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`http://localhost:3000/usuarios/TablaUsuarios/${UserID}`);
